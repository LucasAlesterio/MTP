...
#define N 256
#define L 5
//Ainda em processo de constru豫o, porem com a base pronta!!
    ...
    for (i = 0; i < L; i++)
        for(j = 0 ; j <strlen(palavra[i]); j++)
            if(isalpha(palavra[i][j])==0)
            {
                ...
                printf("\n콲esculpe-me, mas insira palavras contendo apenas letras por favor!�");
                printf("\n께께께께께께께께께께께께께께께께께께께께께께께께께께께께께께께께께께");
                getchar();
                return 1;
            }
...
int verifica_repetida(char palavra[L][N])
{
    ...
    for(i=0; i<L; i++)
        for(j=i+1;j<L;j++)
            ...
            {
                printf("\n께께께께께께께께께께께께께께께께께께께께께께께께께께께께");
                printf("\n콲esculpe-me, mas insira palavras diferentes por favor!�");
                printf("\n께께께께께께께께께께께께께께께께께께께께께께께께께께께께");
                getchar();
                return 1;
            }
